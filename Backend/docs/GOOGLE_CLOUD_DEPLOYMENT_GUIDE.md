# Google Cloud Deployment Guide for Frame Backend API
...
Your **Frame Backend API** is a FastAPI application that provides:
...
4. ✅ **Google Cloud Project**
   ...
   gcloud projects create glass-backend-api --name="Frame Backend API"
