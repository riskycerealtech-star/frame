...
@router.post("/validate-sunglasses", response_model=ValidationResponse, tags=["2. Flame Flow"])
...
@router.post("/validate-sunglasses-base64", response_model=ValidationResponse, tags=["2. Flame Flow"])
